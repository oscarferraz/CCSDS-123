...
void *compute_sample(void *input){
    ...
    clock_gettime(CLOCK_MONOTONIC, &end2);
    printf("core %d=%d, BITSTREAM=%lf\n",args->id, args->bands, (end2.tv_sec-start2.tv_sec)*1e3+(end2.tv_nsec-start2.tv_nsec)*1e-6); 
    ...
    fprintf(fp,"%d\t%lf\n",args->id, (end2.tv_sec-start2.tv_sec)*1e3+(end2.tv_nsec-start2.tv_nsec)*1e-6 );
    fclose(fp); 
...
//printf("%llu\n", millisecondsSinceEpoch);
    ...
    args_sample7 = (struct thread_args_sample *)malloc(sizeof(struct thread_args_sample));
    args_sample8 = (struct thread_args_sample *)malloc(sizeof(struct thread_args_sample));
    ...
    unsigned int * counter7 = NULL;
    unsigned int * accumulator7 = NULL;
    unsigned int * counter8 = NULL;
    unsigned int * accumulator8 = NULL;
    ...
    #ifdef AVIRIS
        /* unsigned int arm1=28;
        unsigned int arm2=28; 
        unsigned int arm3=28; 
        unsigned int arm4=28; 
        unsigned int arm5=28; 
        unsigned int arm6=28; 
        unsigned int arm7=28; 
        unsigned int arm8=28; */

        /* unsigned int arm1=46;
        unsigned int arm2=22; 
        unsigned int arm3=22; 
        unsigned int arm4=22; 
        unsigned int arm5=22; 
        unsigned int arm6=22; 
        unsigned int arm7=22; 
        unsigned int arm8=46; */

        unsigned int arm1=56;
        unsigned int arm2=56; 
        unsigned int arm3=56; 
        unsigned int arm4=56; 
        unsigned int arm5=56; 
        unsigned int arm6=56; 
        unsigned int arm7=56; 
        unsigned int arm8=56;


        /* unsigned int arm1=112;
        unsigned int arm2=112; 
        unsigned int arm3=112; 
        unsigned int arm4=112; 
        unsigned int arm5=112; 
        unsigned int arm6=112; 
        unsigned int arm7=112; 
        unsigned int arm8=112; */

        
    #endif

    #ifdef CRISM
        /* unsigned int arm1=68;
        unsigned int arm2=68; 
        unsigned int arm3=68; 
        unsigned int arm4=68; 
        unsigned int arm5=68; 
        unsigned int arm6=68; 
        unsigned int arm7=68; 
        unsigned int arm8=69;
 */
        /* unsigned int arm1=128;
        unsigned int arm2=51; 
        unsigned int arm3=52; 
        unsigned int arm4=51; 
        unsigned int arm5=52; 
        unsigned int arm6=51; 
        unsigned int arm7=52; 
        unsigned int arm8=108; */

        unsigned int arm1=136;
        unsigned int arm2=136; 
        unsigned int arm3=136; 
        unsigned int arm4=136; 
        unsigned int arm5=136; 
        unsigned int arm6=136; 
        unsigned int arm7=137; 
        unsigned int arm8=137;

        /* unsigned int arm1=272;
        unsigned int arm2=273; 
        unsigned int arm3=272; 
        unsigned int arm4=272; 
        unsigned int arm5=272; 
        unsigned int arm6=272; 
        unsigned int arm7=272; 
        unsigned int arm8=272; */
        ...
        unsigned int arm1=18;
        unsigned int arm2=18; 
        unsigned int arm3=18; 
        unsigned int arm4=18; 
        unsigned int arm5=18; 
        unsigned int arm6=18; 
        unsigned int arm7=18; 
        unsigned int arm8=18;

        /* unsigned int arm1=36;
        unsigned int arm2=36; 
        unsigned int arm3=36; 
        unsigned int arm4=36; 
        unsigned int arm5=36; 
        unsigned int arm6=36; 
        unsigned int arm7=36; 
        unsigned int arm8=36; */
    ...
    counter1 = (unsigned int *)malloc(sizeof(unsigned int)*arm1);
    if(counter1 == NULL){
        fprintf(stderr, "Error in the allocation of the counter2 statistic\n\n");
        return -1;
    }
    accumulator1 = (unsigned int *)malloc(sizeof(unsigned int)*arm1);
    if(accumulator1 == NULL){
        fprintf(stderr, "Error in the allocation of the accumulator1 statistic\n\n");
        return -1;
    }

    counter2 = (unsigned int *)malloc(sizeof(unsigned int)*arm2);
    if(counter2 == NULL){
        fprintf(stderr, "Error in the allocation of the counter2 statistic\n\n");
        return -1;
    }
    accumulator2 = (unsigned int *)malloc(sizeof(unsigned int)*arm2);
    if(accumulator2 == NULL){
        fprintf(stderr, "Error in the allocation of the accumulator2 statistic\n\n");
        return -1;
    }

    counter3 = (unsigned int *)malloc(sizeof(unsigned int)*arm3);
    if(counter3 == NULL){
        fprintf(stderr, "Error in the allocation of the counter3 statistic\n\n");
        return -1;
    }
    accumulator3 = (unsigned int *)malloc(sizeof(unsigned int)*arm3);
    if(accumulator3 == NULL){
        fprintf(stderr, "Error in the allocation of the accumulator3 statistic\n\n");
        return -1;
    }

    counter4 = (unsigned int *)malloc(sizeof(unsigned int)*arm4);
    if(counter4 == NULL){
        fprintf(stderr, "Error in the allocation of the counter6 statistic\n\n");
        return -1;
    }
    accumulator4 = (unsigned int *)malloc(sizeof(unsigned int)*arm4);
    if(accumulator4 == NULL){
        fprintf(stderr, "Error in the allocation of the accumulator6 statistic\n\n");
        return -1;
    }

    counter5 = (unsigned int *)malloc(sizeof(unsigned int)*arm5);
    if(counter5 == NULL){
        fprintf(stderr, "Error in the allocation of the counter5 statistic\n\n");
        return -1;
    }
    accumulator5 = (unsigned int *)malloc(sizeof(unsigned int)*arm5);
    if(accumulator5 == NULL){
        fprintf(stderr, "Error in the allocation of the accumulator5 statistic\n\n");
        return -1;
    }

    counter6 = (unsigned int *)malloc(sizeof(unsigned int)*arm6);
    if(counter6 == NULL){
        fprintf(stderr, "Error in the allocation of the counter6 statistic\n\n");
        return -1;
    }
    accumulator6 = (unsigned int *)malloc(sizeof(unsigned int)*arm6);
    if(accumulator6 == NULL){
        fprintf(stderr, "Error in the allocation of the accumulator6 statistic\n\n");
        return -1;
    }

    counter7 = (unsigned int *)malloc(sizeof(unsigned int)*arm7);
    if(counter7 == NULL){
        fprintf(stderr, "Error in the allocation of the counter5 statistic\n\n");
        return -1;
    }
    accumulator7 = (unsigned int *)malloc(sizeof(unsigned int)*arm7);
    ...
    counter8 = (unsigned int *)malloc(sizeof(unsigned int)*arm8);
    if(counter8 == NULL){
        fprintf(stderr, "Error in the allocation of the counter8 statistic\n\n");
        return -1;
    }
    accumulator8 = (unsigned int *)malloc(sizeof(unsigned int)*arm8);
    if(accumulator8 == NULL){
        fprintf(stderr, "Error in the allocation of the accumulator8 statistic\n\n");
        return -1;
    }
    ...
    args_sample7->compressed_stream=&stream7[0];
    args_sample8->compressed_stream=&stream8[0];
    ...
    args_sample7->written_bytes=&written_bytes7[0];
    args_sample7->written_bits=&written_bits7[0];
    args_sample8->written_bytes=&written_bytes8[0];
    args_sample8->written_bits=&written_bits8[0];

    /* args_sample1->residuals=&residuals[0];
    args_sample2->residuals=&residuals[arm1*input_params.y_size*input_params.x_size];
    args_sample3->residuals=&residuals[(arm1+arm2)*input_params.y_size*input_params.x_size];
    args_sample4->residuals=&residuals[(arm1+arm2+arm3)*input_params.y_size*input_params.x_size];
    args_sample5->residuals=&residuals[(arm1+arm2+arm3+arm4)*input_params.y_size*input_params.x_size];
    args_sample6->residuals=&residuals[(arm1+arm2+arm3+arm4+arm5)*input_params.y_size*input_params.x_size];
    args_sample7->residuals=&residuals[(arm1+arm2+arm3+arm4+arm5+arm6)*input_params.y_size*input_params.x_size];
    args_sample8->residuals=&residuals[(arm1+arm2+arm3+arm4+arm5+arm6+arm7)*input_params.y_size*input_params.x_size]; */

    args_sample1->residuals=&residuals[0];
    //args_sample2->residuals=&residuals[0];
    args_sample3->residuals=&residuals[(arm1)*input_params.y_size*input_params.x_size];
    //args_sample4->residuals=&residuals[(arm2)*input_params.y_size*input_params.x_size];
    args_sample5->residuals=&residuals[(arm1+arm3)*input_params.y_size*input_params.x_size];
    //args_sample6->residuals=&residuals[(arm2+arm4)*input_params.y_size*input_params.x_size];
    args_sample7->residuals=&residuals[(arm1+arm3+arm5)*input_params.y_size*input_params.x_size];
    //args_sample8->residuals=&residuals[(arm2+arm4+arm6)*input_params.y_size*input_params.x_size];

    /* args_sample1->residuals=&residuals[0];
    args_sample2->residuals=&residuals[(arm1)*input_params.y_size*input_params.x_size];
    args_sample3->residuals=&residuals[(arm1+arm2)*input_params.y_size*input_params.x_size];
    args_sample4->residuals=&residuals[(arm1+arm2+arm3)*input_params.y_size*input_params.x_size];
    args_sample5->residuals=&residuals[(arm1+arm2+arm3)*input_params.y_size*input_params.x_size];
    args_sample6->residuals=&residuals[(arm1+arm2+arm3+arm4)*input_params.y_size*input_params.x_size];
    args_sample7->residuals=&residuals[(arm1+arm2+arm3+arm5)*input_params.y_size*input_params.x_size];
    args_sample8->residuals=&residuals[(arm1+arm2+arm3+arm5+arm7)*input_params.y_size*input_params.x_size]; */
    ...
    args_sample7->counter=&counter7[0];
    args_sample8->counter=&counter8[0];
    ...
    args_sample7->accumulator=&accumulator7[0];
    args_sample8->accumulator=&accumulator8[0];


    args_sample1->bands=arm1;
    args_sample2->bands=arm2;
    args_sample3->bands=arm3;
    args_sample4->bands=arm4;
    args_sample5->bands=arm5;
    args_sample6->bands=arm6;
    args_sample7->bands=arm7;
    args_sample8->bands=arm8;
    ...
    args_sample7->input_params=input_params;
    args_sample8->input_params=input_params;
    ...
    args_sample0->stream7=&stream7[0];
    args_sample0->written_bytes7=&written_bytes7[0];
    args_sample0->written_bits7=&written_bits7[0];
    args_sample0->stream8=&stream8[0];
    args_sample0->written_bytes8=&written_bytes8[0];
    args_sample0->written_bits8=&written_bits8[0];
    ...
    if(pthread_attr_init(&(threads_attr[7])) != 0)
        printf("pthread_attr_init");
    if(pthread_attr_setaffinity_np(&(threads_attr[7]), sizeof(cpu_set_t), &cpuset_stream7) != 0)
        printf("pthread_attr_setaffinity_np");

    if(pthread_attr_init(&(threads_attr[8])) != 0)
        printf("pthread_attr_init");
    if(pthread_attr_setaffinity_np(&(threads_attr[8]), sizeof(cpu_set_t), &cpuset_stream8) != 0)
        printf("pthread_attr_setaffinity_np");
    ...
    pthread_create(&threads[7], &(threads_attr[7]), compute_sample, args_sample7);
    //pthread_create(&threads[8], &(threads_attr[8]), compute_sample, args_sample8); 
